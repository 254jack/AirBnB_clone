...
class TestBase(unittest.TestCase):
    ...
    def test_save_no_args(self):
        """Tests save() with zero arguments."""
        self.resetStorage()
    ...
    def test_save_excess_args(self):
        """Tests save() with excess arguments."""
        self.resetStorage()
        with self.assertRaises(TypeError) as e:
